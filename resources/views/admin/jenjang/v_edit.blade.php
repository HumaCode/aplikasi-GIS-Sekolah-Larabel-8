                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label>Jenjang</label>
                                <input type="text" name="jenjang" class="form-control @error('jenjang') is-invalid @enderror" placeholder="Jenjang Pendidikan"  value="{{ old('jenjang', $jenjang->jenjang) }}">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img src="{{ asset('icon') }}/{{ $jenjang->icon }}" width="100">
                        </div>
                    </div>
